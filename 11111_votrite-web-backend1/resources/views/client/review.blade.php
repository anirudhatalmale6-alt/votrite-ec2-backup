		...
		<div class="page-content-fullwidth" style="margin-top: 120px;">
            <div class="col-md-4 col-xs-12">
                ...
                <div class="guide-desc-body">
                    ...
                    <h4 class="a11y-instructions" style="display:none; margin-top:10px; padding:10px; background:#e8eaf6; border-left:4px solid #1a237e;">Keyboard Commands: S = hear all your selections read aloud | J = cast your vote | D = go back and make changes | Escape = cancel ballot entirely | L = hear full help | F3 = exit keyboard mode</h4>
                </div>
            </div>
...
<div class="page-footer-voter" style="text-align:center; padding-top: 35px; color:white; position: absolute; width: 100%;">
    ...
    <div class="col-md-3 col-xs-3" style="padding: 0px;">
        <button type="button" class="btn-voter">Cast my vote</button>
	</div>
</div>
@endsection
@section('script')
